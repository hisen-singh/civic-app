...
├── functions/                 # Firebase Cloud Functions (26 functions)
...
- **Smart Reporting:** Geolocation, camera integration, and urgency tagging.
- **Interactive Map:** Real-time marker clustering and neighborhood Watch Areas.
- **Community Resolution:** Upvote issues, join as a solver, and track resolution status.
- **Gamification:** Earn trust scores, rank on leaderboards, and unlock achievement badges.
- **Offline Mode:** Seamless offline queueing and background sync for low-connectivity areas.

### App Navigation

The app utilizes a Tab-based primary navigation with Stack overlays:

- **Home (Feed):** Algorithmic timeline of trending, recent, and nearby issues.
- **Map:** Global interactive view for spatial awareness.
- **Solve:** Dedicated dashboard for issues you've committed to helping with.
- **Profile:** Personal statistics, unlocked badges, and app settings (localization, notifications).
- **Stack Screens:** Issue Details, User Profiles, Analytics, Edit Profile, Watch Areas, Achievements.
...
### Firebase Cloud Functions (26 deployed)
...
| _(+15 more)_             | Various            | Analytics, achievements, user matching, etc.     |
