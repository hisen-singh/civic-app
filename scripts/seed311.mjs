...
const MOCK_ISSUES = [
  {
    ...
    description:
      'There is a massive pothole in the right lane that has damaged at least 3 cars today. Needs immediate filling before a major accident occurs.',
  ...
  },
  {
    ...
    description:
      'The traffic light is completely out in all directions. Currently treating it as a 4-way stop but traffic is backing up severely.',
    authorName: 'City 311 Open Data',
  },
  {
    ...
    description:
      'Someone spray painted tags all over the bronze memorial statue last night.',
    authorName: 'City 311 Open Data',
  },
  {
    ...
    description:
      'Several mattresses, broken furniture, and construction debris dumped illegally, blocking the alley for garbage trucks.',
    authorName: 'City 311 Open Data',
  },
  {
    ...
    description:
      'Water is gushing out from under the pavement, flooding the street and freezing. Dangerous driving conditions.',
    authorName: 'City 311 Open Data',
  },
  {
    ...
    description:
      'Large oak branch snapped during the storm and is resting directly on the power lines. Sparks visible.',
    authorName: 'City 311 Open Data',
  },
  {
    ...
    description:
      'All public trash bins along the trail are overflowing, trash blowing into the water.',
    authorName: 'City 311 Open Data',
  },
  {
    ...
    description:
      'Tree roots have buckled the sidewalk by over 4 inches. Major trip hazard for elderly residents.',
    authorName: 'City 311 Open Data',
  },
  {
    ...
    description:
      'Pitch black on this block for the last 3 nights. Very unsafe for pedestrians.',
    authorName: 'City 311 Open Data',
  },
  {
    ...
    description:
      'Silver sedan with no plates has been abandoned here for 3 weeks.',
    authorName: 'City 311 Open Data',
  },
];
