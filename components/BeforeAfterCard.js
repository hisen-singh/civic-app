...
export default function BeforeAfterCard({ beforePhoto, afterPhoto, title }) {
  ...
  const beforeOpacity = slideAnim.interpolate({
    inputRange: [0, 1],
    outputRange: [1, 0],
  });
  const afterOpacity = slideAnim.interpolate({
    inputRange: [0, 1],
    outputRange: [0, 1],
  });
    ...
    <View style={styles.container}>
      ...
      <View style={styles.toggleRow}>
        <TouchableOpacity
          ...
          activeOpacity={0.7}
          style={[styles.togglePill, !showAfter && styles.togglePillActive]}
        >
          <Text
            style={[styles.toggleText, !showAfter && styles.toggleTextActive]}
          >
            Before
          </Text>
        </TouchableOpacity>
