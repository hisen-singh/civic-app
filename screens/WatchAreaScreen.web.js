    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.helperText}>
          Map selection not supported on web mockup.
        </Text>
        ...
        <View style={styles.mapContainer}>
          ...
          >
            <Text style={{ color: Colors.textSecondary }}>
              Interactive Map requires Native App.
            </Text>
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.listContainer}>
        <Text style={styles.description}>
          Receive alerts when critical issues are reported in your tracked
          neighborhoods.
        </Text>
        ...
        {watchAreas.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyDesc}>
              Set up areas like "Home" or "Office" to stay informed about local
              issues.
            </Text>
          </View>
        ) : (
            ...
            <Card key={area.id} style={styles.areaCard}>
              <Card.Content style={styles.areaContent}>
                <View style={styles.areaInfo}>
                  ...
                  <Text style={styles.areaSub}>
                    Lat: {area.latitude.toFixed(3)}, Lng:{" "}
