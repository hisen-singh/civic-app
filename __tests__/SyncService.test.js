...
describe("SyncService", () => {
  ...
  it("processes queue and uploads local photos when online", async () => {
    ...
    IssueService.uploadImage.mockResolvedValueOnce(
      "https://firebase.storage/photo.jpg",
    );
    IssueService.addIssue.mockResolvedValueOnce({ id: "123" });

    await SyncService.processQueue();

    expect(IssueService.uploadImage).toHaveBeenCalledWith(
      "file:///mock/doc/dir/photo.jpg",
    );
